/*
 * capture.cpp
 * Captura de paquetes via Npcap/WinPcap. Parsea Ethernet -> IP ->
 * TCP/UDP/ICMP, aplica filtros y alimenta la tabla de nodos (nodes.cpp)
 * para el Area 4 y el panel de Top Talkers.
 */
