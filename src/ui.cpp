 ...
 *  - Mouse: click para seleccionar paquete, click en botones de menu,
 *    click en Area 4 para filtrar trafico por dispositivo
 *  - Auto-scroll que sigue el ultimo paquete
 *  - Tecla T: panel de Top Talkers (reemplaza Area 1 temporalmente)
 *  - Start/Stop usa want_restart; el watchdog en main.cpp relanza
 *    el hilo de captura.
 *
 * NOTA: requiere consola alta (recomendado: maximizar ventana o
 * usar al menos ~45 filas) para que Area 4 sea visible sin recortes.
 */
